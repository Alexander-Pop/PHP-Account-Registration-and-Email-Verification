...
<html>
	...
	<body>
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<div class="col-md-offset-1 col-md-6">
							<?php if(empty($upload)) : ?>
								<h4 class="text"><i>You not uploaded anything yet</i></h4>
							<?php else : ?>
								<img class="img-responsive" src="'.$upload.'" alt="image">
							<?php endif; ?>
						</div>
					</div>
				</div>
		...
		<div class="text-center" style="margin-top: 175px; color: #000;"><b>Some text placeholder</b></div>
